...
export const studentAPI = {
    ...
    getMyAssignments: () => api.get('/student/assignments'),
    ...
    claimCertificate: (courseId) => api.post(`/student/course/${courseId}/claim-certificate`),
...
export const instructorAPI = {
    ...
    createAssignment: (courseId, data) => api.post(`/instructor/courses/${courseId}/assignments`, data),
    getCourseAssignments: (courseId) => api.get(`/instructor/courses/${courseId}/assignments`),
    getAssignmentSubmissions: (assignmentId) => api.get(`/instructor/assignments/${assignmentId}/submissions`),
    gradeSubmission: (submissionId, data) => api.put(`/instructor/submissions/${submissionId}/grade`, data),
